...
const Agenda = () => {
  ...
  const getEventTypeBadge = (type) => {
    switch (type) {
      case "workshop": return <Badge className="bg-blue-500 hover:bg-blue-600">Workshop</Badge>;
      case "keynote": return <Badge className="bg-purple-500 hover:bg-purple-600">Keynote</Badge>;
      case "break": return <Badge className="bg-gray-500 hover:bg-gray-600">Break</Badge>;
  ...
  <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <div className={`transition-all duration-300 ${isMobile ? "pl-0" : "pl-64"}`}>
      <main className="container mx-auto py-8 px-4">
        ...
        {groupedEvents[activeMonth] &&
          Object.entries(groupedEvents[activeMonth]).map(([day, dayEvents]) => (
          <div key={day} className="mb-6">
            <h3 className="text-lg font-semibold text-gray-600 dark:text-gray-300 mb-2">{day}</h3>
